...
pub struct Gists<'api, C: Client<Req = crate::adapters::Req>> {
    client: &'api C
}

pub fn new<C: Client<Req = crate::adapters::Req>>(client: &C) -> Gists<C> {
    Gists { client }
}
...
impl<'api, C: Client<Req = crate::adapters::Req>> Gists<'api, C> {
    /// ---
    ///
    ...
    pub async fn check_is_starred_async(&self, gist_id: &str) -> Result<(), GistsCheckIsStarredError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsCheckIsStarredError::Status404(github_response.to_json_async().await?)),
                304 => Err(GistsCheckIsStarredError::Status304),
                403 => Err(GistsCheckIsStarredError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn create_async(&self, body: PostGistsCreate) -> Result<GistSimple, GistsCreateError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(GistsCreateError::Status422(github_response.to_json_async().await?)),
                304 => Err(GistsCreateError::Status304),
                404 => Err(GistsCreateError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsCreateError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn create_comment_async(&self, gist_id: &str, body: PostGistsCreateComment) -> Result<GistComment, GistsCreateCommentError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                404 => Err(GistsCreateCommentError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsCreateCommentError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn delete_async(&self, gist_id: &str) -> Result<(), GistsDeleteError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsDeleteError::Status404(github_response.to_json_async().await?)),
                304 => Err(GistsDeleteError::Status304),
                403 => Err(GistsDeleteError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn delete_comment_async(&self, gist_id: &str, comment_id: i64) -> Result<(), GistsDeleteCommentError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                404 => Err(GistsDeleteCommentError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsDeleteCommentError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn fork_async(&self, gist_id: &str) -> Result<BaseGist, GistsForkError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsForkError::Status404(github_response.to_json_async().await?)),
                422 => Err(GistsForkError::Status422(github_response.to_json_async().await?)),
                304 => Err(GistsForkError::Status304),
                403 => Err(GistsForkError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn get_async(&self, gist_id: &str) -> Result<GistSimple, GistsGetError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                403 => Err(GistsGetError::Status403(github_response.to_json_async().await?)),
                404 => Err(GistsGetError::Status404(github_response.to_json_async().await?)),
    ...
    pub async fn get_comment_async(&self, gist_id: &str, comment_id: i64) -> Result<GistComment, GistsGetCommentError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                404 => Err(GistsGetCommentError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsGetCommentError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn get_revision_async(&self, gist_id: &str, sha: &str) -> Result<GistSimple, GistsGetRevisionError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(GistsGetRevisionError::Status422(github_response.to_json_async().await?)),
                404 => Err(GistsGetRevisionError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsGetRevisionError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_async(&self, query_params: Option<impl Into<GistsListParams>>) -> Result<Vec<BaseGist>, GistsListError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                403 => Err(GistsListError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_comments_async(&self, gist_id: &str, query_params: Option<impl Into<GistsListCommentsParams>>) -> Result<Vec<GistComment>, GistsListCommentsError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                404 => Err(GistsListCommentsError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsListCommentsError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_commits_async(&self, gist_id: &str, query_params: Option<impl Into<GistsListCommitsParams>>) -> Result<Vec<GistCommit>, GistsListCommitsError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsListCommitsError::Status404(github_response.to_json_async().await?)),
                304 => Err(GistsListCommitsError::Status304),
                403 => Err(GistsListCommitsError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_for_user_async(&self, username: &str, query_params: Option<impl Into<GistsListForUserParams>>) -> Result<Vec<BaseGist>, GistsListForUserError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(GistsListForUserError::Status422(github_response.to_json_async().await?)),
    ...
    pub async fn list_forks_async(&self, gist_id: &str, query_params: Option<impl Into<GistsListForksParams>>) -> Result<Vec<GistSimple>, GistsListForksError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsListForksError::Status404(github_response.to_json_async().await?)),
                304 => Err(GistsListForksError::Status304),
                403 => Err(GistsListForksError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_public_async(&self, query_params: Option<impl Into<GistsListPublicParams>>) -> Result<Vec<BaseGist>, GistsListPublicError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(GistsListPublicError::Status422(github_response.to_json_async().await?)),
                304 => Err(GistsListPublicError::Status304),
                403 => Err(GistsListPublicError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn list_starred_async(&self, query_params: Option<impl Into<GistsListStarredParams>>) -> Result<Vec<BaseGist>, GistsListStarredError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                401 => Err(GistsListStarredError::Status401(github_response.to_json_async().await?)),
                304 => Err(GistsListStarredError::Status304),
                403 => Err(GistsListStarredError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn star_async(&self, gist_id: &str) -> Result<(), GistsStarError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsStarError::Status404(github_response.to_json_async().await?)),
                304 => Err(GistsStarError::Status304),
                403 => Err(GistsStarError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn unstar_async(&self, gist_id: &str) -> Result<(), GistsUnstarError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                ...
                404 => Err(GistsUnstarError::Status404(github_response.to_json_async().await?)),
                403 => Err(GistsUnstarError::Status403(github_response.to_json_async().await?)),
    ...
    pub async fn update_async(&self, gist_id: &str, body: PatchGistsUpdate) -> Result<GistSimple, GistsUpdateError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(GistsUpdateError::Status422(github_response.to_json_async().await?)),
                404 => Err(GistsUpdateError::Status404(github_response.to_json_async().await?)),
    ...
    pub async fn update_comment_async(&self, gist_id: &str, comment_id: i64, body: PatchGistsUpdateComment) -> Result<GistComment, GistsUpdateCommentError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                404 => Err(GistsUpdateCommentError::Status404(github_response.to_json_async().await?)),
