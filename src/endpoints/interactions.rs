...
pub struct Interactions<'api, C: Client<Req = crate::adapters::Req>> {
    client: &'api C
}

pub fn new<C: Client<Req = crate::adapters::Req>>(client: &C) -> Interactions<C> {
    Interactions { client }
}
...
impl<'api, C: Client<Req = crate::adapters::Req>> Interactions<'api, C> {
    /// ---
    ///
    ...
    pub async fn set_restrictions_for_authenticated_user_async(&self, body: PutInteractionsSetRestrictionsForAuthenticatedUser) -> Result<InteractionLimitResponse, InteractionsSetRestrictionsForAuthenticatedUserError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(InteractionsSetRestrictionsForAuthenticatedUserError::Status422(github_response.to_json_async().await?)),
    ...
    pub async fn set_restrictions_for_org_async(&self, org: &str, body: PutInteractionsSetRestrictionsForAuthenticatedUser) -> Result<InteractionLimitResponse, InteractionsSetRestrictionsForOrgError> {
        ...
        if github_response.is_success() {
            ...
            match github_response.status_code() {
                422 => Err(InteractionsSetRestrictionsForOrgError::Status422(github_response.to_json_async().await?)),
